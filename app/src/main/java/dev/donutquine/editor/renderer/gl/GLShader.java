...
public class GLShader extends Shader {
    ...
    private static int createProgram(GLRendererContext gl, int vertexShaderId, int fragmentShaderId) {
        ...
        GLES20.glBindAttribLocation(programId,0,"aPos");
        GLES20.glBindAttribLocation(programId,1,"aTexCoord");
        GLES20.glBindAttribLocation(programId,2,"aColorMul");
        GLES20.glBindAttribLocation(programId,3,"aColorAdd");
